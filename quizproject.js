...
let questions = [
 ...
 function markIt(ans) {
    ...
    if (currentQuestion >= questions.length) {
       ...
       if(score <= 4){
         message= score + " / " + questions.length + " Sorry, you did not score well"
       }
       else if(score <= 7){
         message= score + " / " + questions.length + " You got a decent score!"
       }
       else {
         message= score + " / " + questions.length + " you did exelent!!"
       }
    } else {
       loadQuestion();
    }
